...
class DataGen:
    ...
    def load_data(self, path):
        ...
        self.logger.log("Training data: {}".format(str(self.data["x_train"].shape)))
        self.logger.log("Training labels: {}".format(str(self.data["y_train"].shape)))
        self.logger.log("Testing data: {}".format(str(self.data["x_test"].shape)))
        self.logger.log("Testing labels: {}".format(str(self.data["y_test"].shape)))
